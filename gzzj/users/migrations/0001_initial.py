    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ismanager', models.BooleanField(default=False, verbose_name='是否部门管理员')),
        ...
        migrations.AddField(
            model_name='users',
            name='dept',
            field=models.ForeignKey(default='1', on_delete=django.db.models.deletion.CASCADE, to='users.Dept', verbose_name='所属部门'),
        ),
        migrations.AddField(
            model_name='users',
            name='groups',
